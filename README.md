...
| 店舗リスト画面   | 検索条件に合致した店舗をリストで表示する画面                           | - LazyColumn表示<br>- スクロールして更新<br>- ページングによる追加読み込み（Shimmerあり）<br>- お気に入り追加 |
| 店舗地図表示画面     | Google Maps上に検索条件に合致した店舗をマーカーとリストで表示                          | - マップ操作（ズーム・移動）<br>- Google Maps上に検索結果の店舗をマーカーで表示し、横スクロール可能な店舗リストと連動表示<br>- 店舗詳細との連携   <br>- お気に入り追加          |
